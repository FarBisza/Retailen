            ...
            <div className="max-w-[1400px] mx-auto px-6">
                    ...
                    <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-8">
                        <div className="flex flex-col gap-6">
                            ...
                            <ul className="flex flex-col gap-4 text-xs font-medium text-gray-500">
                                <li><a href="#" className="hover:text-black transition-colors">About Belo.fur</a></li>
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <ul className="flex flex-col gap-4 text-xs font-medium text-gray-500">
                                <li><a href="mailto:hello@belofur.com" className="hover:text-black transition-colors">hello@belofur.com</a></li>
                ...
                <div className="border-t border-gray-50 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="text-[10px] font-medium text-gray-400">
                        © Belo.fur 2025 All right reserved
                    </div>
