            ...
            <div className="max-w-[1400px] mx-auto px-6">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-8">
                        <div className="text-4xl font-bold tracking-tighter">Mers</div>
                    ...
                    <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-8">
                        <div className="flex flex-col gap-6">
                            ...
                            <ul className="flex flex-col gap-4 text-xs font-medium text-gray-500">
                                <li><a href="#" className="hover:text-black transition-colors">About Mers</a></li>
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <ul className="flex flex-col gap-4 text-xs font-medium text-gray-500">
                                <li><a href="mailto:hello@mers.com" className="hover:text-black transition-colors">hello@mers.com</a></li>
